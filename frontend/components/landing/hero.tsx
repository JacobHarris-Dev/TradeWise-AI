...
const LandingHeroChart = dynamic(
  () =>
    import("./hero-chart").then((mod) => mod.LandingHeroChart),
  {
    ssr: false,
    loading: () => (
      <div className="mt-8 flex h-[260px] w-full items-center justify-center rounded-3xl border border-slate-200 bg-[linear-gradient(180deg,rgba(248,250,252,0.9),rgba(255,255,255,0.55))] p-4 text-sm text-slate-500 sm:h-[320px]">
        Loading chart...
      </div>
    ),
  },
